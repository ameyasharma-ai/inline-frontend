        ...
        if (activeFile) {
            toast.custom((t) => (
                <div className="flex flex-col gap-3 rounded-xl border border-white/10 bg-[#1e1e2e] p-4 shadow-xl">
                    <p className="text-white">Are you sure you want to replace the code in the file?</p>
                        ...
                        code({ inline, className, children, ...props }: any) {
                            ...
                            return !inline ? (
                                    <SyntaxHighlighter
                                        ...
                                        language={language}
                                        PreTag="pre"
                                        className="!m-0 !h-full !rounded-xl !border !border-white/10 !bg-white/5 !p-4 !backdrop-blur-sm"
                                    >
